  ...
  return (
    <footer className="bg-slate-900 text-slate-300 py-12 px-4">
      <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <a href="mailto:Jose Ortiz <joseortizgarciaq.ca@gmail.com>" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">
                  joseortizgarciaq.ca@gmail.com
                </a>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-6 h-6 bg-slate-800 rounded-lg flex items-center justify-center">
                ...
                <span className="text-slate-400 text-sm">Montréal, QC</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Social Links */}
        <div className="flex justify-center space-x-4 py-6 border-t border-slate-800">
          <a 
            href="https://www.linkedin.com/in/joseortiz-q/?originalSubdomain=ca" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="w-8 h-8 bg-slate-800 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-all duration-300 group"
          >
          ...
          <a 
            href="https://github.com/JoseOrtizQ" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="w-8 h-8 bg-slate-800 hover:bg-gray-700 rounded-lg flex items-center justify-center transition-all duration-300 group"
          >
            <svg className="w-4 h-4 text-slate-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center pt-4 border-t border-slate-800">
          <p className="text-slate-400 text-sm">
            © {currentYear} José Ortiz. All rights reserved. Built with React & Tailwind CSS.
          </p>
        </div>
      </div>
    </footer>
